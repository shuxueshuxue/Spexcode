export default {
  ...
  settings: {
    ...
    launcherConfigPath: '另外，你也可以直接编辑 spexcode.json 做高级修改。',
    launcherName: '启动器名称',
    ...
    noLaunchers: '尚未配置启动器。',
    secHarnesses: '添加 harness',
    harnessesDescription: '选择接收 SpexCode 的内置 harness。保存会调用项目主机 API 并执行 materialize。',
    harnessesNoProject: '请打开项目范围的 Dashboard 来配置 harness 投递。',
    harnessesLoading: '正在读取项目配置……',
    harnessesNone: '尚未配置内置 harness 目标。',
    harnessesNoAvailable: '所有内置 harness 都已配置。',
    harnessesSelect: '内置 harness 目标',
    harnessesAdd: '添加 harness',
    harnessesSaving: '保存中……',
    harnessLoadFailed: '无法读取项目配置。',
    harnessInvalidConfig: '项目配置无效。',
    harnessSaveFailed: '无法添加 harness 目标。',
    secConfig: '项目配置',
    configDescription: '查看或编辑 CLI 与 host 共用的 portable spexcode.json。',
    configOpen: '打开 spexcode.json',
    configClose: '关闭编辑器',
    configEditor: 'spexcode.json 内容',
    configLoading: '加载中……',
    configSaving: '保存中……',
    ...
    configReload: '重新加载',
    configSaved: '已保存。',
    configLoadFailed: '无法读取 spexcode.json。',
    configSaveFailed: '无法保存 spexcode.json。',
