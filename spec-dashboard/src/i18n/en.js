export default {
  ...
  session: {
    ...
    // the read-only forum info page ([[forum-view]]) — the second top pill beside New Session.
    forumTitle: 'Forum — read the git-native proposals & notes',
    forumOff: 'The forum is off.',
    forumEmpty: 'The forum is empty.',
    forumLoading: 'loading forum…',
    forumFocusNode: 'focus this node on the board',
    forumKind: { proposal: 'proposal', note: 'note' },
    forumSigned: ({ n }) => `+${n} signed`,
    forumReplies: ({ n }) => `${n} ${n === 1 ? 'reply' : 'replies'}`,
    // the human write path ([[forum-view]]) — a reply composer + a New proposal/note affordance.
    forumNew: 'New',
    forumCancel: 'Cancel',
    forumSend: 'Send',
    forumPost: 'Post',
    forumSending: 'sending…',
    forumMentionHint: '@session to summon · [[node]] to link',
    forumReplyPlaceholder: 'reply…',
    forumConcernPlaceholder: 'concern — one line',
    forumNodesPlaceholder: 'node ids, comma-separated (optional)',
    forumBodyPlaceholder: 'details (optional)',
