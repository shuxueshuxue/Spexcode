export default {
  ...
  projects: {
    ...
    configTitle: '编辑 spexcode.json',
    configEditor: 'spexcode.json 内容',
    configLoading: '加载中…',
    configSave: '保存',
    configSaving: '保存中…',
    configReload: '重新加载',
  ...
  session: {
    ...
    addHarnessTarget: '添加 harness 目标',
    addHarnessTargetTitle: '添加 harness 目标',
    addHarnessTargetDescription: '选择此项目要接收 SpexCode 注入的目标，然后写入配置并执行 materialize。外部 adapter 不在 Dashboard 中管理。',
    harnessTargetMode: '目标类型',
    harnessTargetNative: '内置 harness',
    harnessTargetPlugin: '插件宿主目录',
    harnessTargetNativeSelect: '内置 harness',
    harnessTargetPluginFolder: '插件宿主目录',
    harnessTargetPluginHelp: '这里不是 .spec/spexcode/.plugins：那是 SpexCode 自己的内置插件源码。请填写外部智能体在项目内扫描的目录，例如 .claude 或 .adopter-a；生成的 bundle 会写入 <目录>/plugins/spexcode。',
    harnessTargetPluginPlaceholder: '.adopter-a',
    harnessTargetCurrent: '当前目标',
    harnessTargetNone: '无',
    harnessTargetNoNative: '没有可用的内置 harness',
    harnessTargetLoading: '正在读取项目配置……',
    harnessTargetSaving: '正在保存并执行 materialize……',
    harnessTargetSave: '添加目标',
    harnessTargetTranscript: 'materialize 输出',
    harnessTargetAlreadyAdded: '此目标已经配置',
    harnessTargetNoProject: '请在项目会话中添加目标',
    harnessTargetHostUnavailable: '主机项目服务不可用',
    harnessTargetAdminRequired: '需要管理员权限',
    harnessTargetLoadFailed: '无法读取项目配置',
    harnessTargetInvalidConfig: '项目配置无效',
    harnessTargetSelectionMissing: 'spexcode.json 尚未选择 harness 目标，请先在项目设置中完成选择',
    harnessTargetSelectionMalformed: 'spexcode.json 的 harnesses 必须是数组，请先在项目设置中修复',
    harnessTargetMaterializeFailed: 'materialize 失败',
    harnessTargetSaveFailed: '无法添加 harness 目标',
    harnessTargetRefreshFailed: '目标已保存，但无法刷新启动器列表',
    harnessTargetAdded: 'harness 目标已添加',
    tabTerminal: '终端',
    tabConversation: '对话',
    tabDiff: '差异',
    ...
    diffGroupCommitted: '已提交（{n}）',
    diffGroupUncommitted: '未提交（{n}）',
    diffUncommitted: '未提交',
