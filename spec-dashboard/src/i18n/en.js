export default {
  ...
  plugins: {
    ...
    installed: 'Declared once, installed per worktree',
    matching: 'carry the declared contract',
    differing: 'run something else',
    unmaterialized: 'run no hooks at all',
    ofTrees: ({ trees }) => `of ${trees} worktrees`,
    liveAria: ({ matching, trees }) => `${matching} of ${trees} worktrees carry the declared hook contract`,
