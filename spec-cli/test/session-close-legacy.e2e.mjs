...
try {
  ...
  run(project, ['worktree', 'remove', '--force', worktree])
  ...
  console.log(JSON.stringify({ ok: true, id, legacyArchived: projected.archived, resumeStatus: resume.status, resumeBody }))
} catch (error) {
