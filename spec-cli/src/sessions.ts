...
function corruptSession(id: string, entry: { path: string; error: string }): Session {
  ...
  return {
    ...
    activity: null, sortKey: null, archiveHazard: null, files: [], web: [], widgets: [],
  }
}
