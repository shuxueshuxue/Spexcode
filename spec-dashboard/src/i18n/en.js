export default {
  ...
  session: {
    ...
    // the shelf ([[archive]]) — wording never implies a stop, because shelving does not stop anything
    viewGroup: 'session list view',
    shelfShow: 'shelf — sessions you set aside',
    shelfHide: 'back to the working set',
    shelfEmpty: 'nothing on the shelf',
    shelfMsg: '★ shelved — set aside, nothing was stopped or removed.',
    shelfSubLive: 'its agent is still running and its worktree is untouched. restore it to the list whenever you want it back.',
    shelfSubOffline: 'its process has exited, but the worktree and conversation are intact — restore it, and relaunch when you want to work on it again.',
    shelfRestore: '★ restore to list',
    ...
    cmd: {
      ...
      archiveTitle: 'shelve this session (out of the list; nothing stopped)',
      archiveDesc: 'archive — file it out of the list. the agent keeps running and the worktree stays; pair with /stop to free the process',
      unarchiveTitle: 'restore this session to the list',
      unarchiveDesc: 'unarchive — bring it back into the working set',
