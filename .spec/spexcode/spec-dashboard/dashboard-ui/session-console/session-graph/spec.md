...
the two nodes, never crushed border-to-border. The count rides a small chip drawn in the **board's own light
palette** — a soft paper tone, not a foreign dark badge — so it reads as part of the board rather than a blot
over it. Linking draws sessions close, but no closer than legible.
