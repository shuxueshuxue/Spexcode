...
It keeps dashboard immediately after its core dependency and before CLI, then covers the actual committed
manifests, the controlled partial-registry refusal, and a real package-directory
