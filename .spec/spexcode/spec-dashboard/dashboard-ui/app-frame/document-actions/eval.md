...
scenarios:
  - name: session-actions-live-in-shell-slot
    ...
    description: >-
      ...
      Then navigate to a spec document and inspect the same shell row.
    expected: >-
      ...
      document, while the shell tab row remains. Settled screenshots show the terminal or timeline
      directly below the one tab row.
