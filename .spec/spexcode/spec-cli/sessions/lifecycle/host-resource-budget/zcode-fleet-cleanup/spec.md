---
title: z-code fleet cleanup
hue: 34
desc: A per-record, evidence-backed execution ledger for retiring the MBP z-code session fleet without losing externally referenced or unmerged work.
code:
  - reports/zcode-session-cleanup-ledger-2026-07-27.md
---

# z-code-fleet-cleanup

## raw source

The MBP z-code fleet may be cleaned only from live ownership evidence. Archive and lifecycle labels do not
