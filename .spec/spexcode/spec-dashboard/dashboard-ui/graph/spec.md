...
- [[node-graph]] — the drill-down tidy-tree itself, the centre of the view; [[graph-stats]] contributes the
  graph walk behind the shell-owned board ledger rather than mounting a second tally HUD.
