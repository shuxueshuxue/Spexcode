...
test('ordinary interactive launch posts the prompt, launcher, and optional initial name', async () => {
  ...
  try {
    const result = await createSession('/tidy [[mobile-ui]] keep the composer', 'codex-local', '  Mobile tidy  ')
