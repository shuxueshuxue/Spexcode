...
//   1. STRING LITERALS in source under spec-cli/src, packages/session-*/src, spec-forge/src,
...
const DEAD = /\b(yatsu|readings?|boards?|proofs?|blobs?|scan(?:s|ned|ning)?|reopen(?:s|ed|ing)?|rawkeys?|loss-signals?|evals?|codeSha)\b/i
