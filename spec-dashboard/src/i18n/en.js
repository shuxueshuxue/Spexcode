...
export default {
  ...
  settings: {
    ...
    secShortcuts: 'shortcuts & controller',
    padOn: '🎮 controller connected',
    padOff: '🎮 no controller',
    bindPrompt: 'press a key…',
    bindPromptPad: 'press a button…',
    shortcutsHint: 'click a keyboard or controller cell to rebind it. nav & chord keys are fixed.',
