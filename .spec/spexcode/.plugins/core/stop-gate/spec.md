...
On a clean declared stop, the gate allows the session after enforcing its lifecycle and commit rules. Product proof is handed to the reviewer through session files, not filed as readings.
