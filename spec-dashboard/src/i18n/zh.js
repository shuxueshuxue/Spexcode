export default {
  ...
  projects: {
    ...
    initGit: '初始化 Git 并创建首个提交',
    initialCommitMissing: '此 Git 仓库还没有首个提交，提交后才能创建会话',
    repairInitialCommit: '补齐首个提交',
  ...
  session: {
    ...
    executionTitle: '执行过程',
    executionOpen: '查看当前执行过程',
    executionClose: '关闭执行过程',
    executionRunning: '执行中',
    executionDone: '已完成',
    executionEmpty: '等待工具步骤',
    filesTitle: '会话文件',
    ...
    cmd: {
      ...
      archiveTitle: '归档此会话',
      archiveDesc: '归档 —— 精确停止运行时，保留工作树与对话以便恢复',
      unarchiveTitle: '恢复并重新启动此会话',
      unarchiveDesc: '已弃用 —— 使用恢复以重新启动同一对话',
