export default {
  ...
  projects: {
    ...
    initGit: 'initialize Git and create the first commit',
    initialCommitMissing: 'this Git repository has no initial commit; create one before starting sessions',
    repairInitialCommit: 'create the first commit',
  ...
  session: {
    ...
    cmd: {
      ...
      archiveDesc: 'archive — exact-stop its runtime, keep the worktree and conversation for resume',
      unarchiveTitle: 'resume and relaunch this session',
      unarchiveDesc: 'deprecated — use resume to relaunch the same conversation',
