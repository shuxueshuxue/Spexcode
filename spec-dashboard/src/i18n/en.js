export default {
  ...
  session: {
    ...
    harnessTargetPluginHelp: 'A plugin folder is the host agent scan directory. SpexCode installs one bundle at <folder>/plugins/spexcode; use this only for a plugin host, not a built-in harness.',
