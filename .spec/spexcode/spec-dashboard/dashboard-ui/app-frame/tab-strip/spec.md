...
**The row is always there, and it always says something.** On the routes that mint no tab — the graph and the
sessions launch page — the strip names the PLACE instead: the same projection the
