export default {
  ...
  settings: {
    ...
    launcherConfigPath: 'Optionally, you can also edit spexcode.json directly for advanced changes.',
    ...
    secHarnesses: 'Add a harness',
    harnessesDescription: 'Choose which built-in harnesses receive SpexCode. Saving uses the host project API and runs materialize.',
    harnessesNoProject: 'Open a project-scoped dashboard to configure harness delivery.',
    harnessesLoading: 'Loading project configuration…',
    harnessesNone: 'No built-in harness targets configured.',
    harnessesNoAvailable: 'All built-in harnesses are already configured.',
    harnessesSelect: 'built-in harness target',
    harnessesAdd: 'Add harness',
    harnessesSaving: 'Saving…',
    harnessLoadFailed: 'Could not load project configuration.',
    harnessInvalidConfig: 'Project configuration is invalid.',
    harnessSaveFailed: 'Could not add the harness target.',
    secConfig: 'Project config',
    configDescription: 'View or edit the portable spexcode.json source used by the CLI and host.',
    configOpen: 'Open spexcode.json',
    ...
    configReload: 'Reload',
    configSaved: 'Saved.',
    configLoadFailed: 'Could not load spexcode.json.',
    configSaveFailed: 'Could not save spexcode.json.',
