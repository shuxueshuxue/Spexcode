      ...
      <div className="si-panel" ref={panelRef} onMouseDownCapture={inertChromePress}>
        ...
        <aside className="si-list" ref={listRef} style={{ flex: `0 0 ${listW}px` }}>
          ...
          <div className="si-board-scroll" data-session-board-scroll>
            ...
            {archiveZoneOpen && <button type="button" className="si-zone-all" onClick={openArchivePage}>
              {t('session.archiveViewAll', { n: archivedSessions.length })} <Icon name="chevron-right" size={14} />
            </button>}
          </div>
        </aside>
