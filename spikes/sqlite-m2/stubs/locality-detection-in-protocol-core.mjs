...
// Flip: locality-detection-in-protocol-core
// Frozen claim it violates: storage locality is the adopter resolver's fail-closed precondition, not protocol core's job
