...
// Flip: converts-wal-instead-of-refusing
// Frozen claim it violates: a database left in WAL is refused; v1 has no runtime dual path and never converts
// This file differs from engine.mjs in exactly 1 place(s).
