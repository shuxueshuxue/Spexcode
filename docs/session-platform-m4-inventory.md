...
The trace mechanism is the deletion gate's selected `/usr/bin/strace -f -qq -e trace=%file -s 4096` mechanism
(`docs/session-legacy-deletion-gate.md:98-125`). Both disposable runs put the checkout, `SPEXCODE_HOME`, `TMPDIR`
...
release, installed-project and runtime population under `docs/session-legacy-deletion-gate.md:47-76`.
