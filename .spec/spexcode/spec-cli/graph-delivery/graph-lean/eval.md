...
scenarios:
  - name: lean-board-detail-and-search-intact
    ...
    code: [packages/spec-core/src/graph.ts, spec-dashboard/src/NodeView.jsx, spec-dashboard/src/SpecSearch.jsx]
  ...
  - name: eval-history-off-the-board
    ...
    code: [packages/spec-core/src/graph.ts, spec-dashboard/src/NodeView.jsx]
  - name: scenario-prose-off-the-board
    ...
    code: [packages/spec-core/src/graph.ts, spec-cli/src/index.ts, spec-dashboard/src/corpus.js, spec-dashboard/src/SpecSearch.jsx, spec-dashboard/src/NodeView.jsx]
---
