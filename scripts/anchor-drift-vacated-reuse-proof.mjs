...
async function vacatedReuse() {
  ...
  try {
    ...
    const { historyIndex, rowsFor, driftIndex, pathRangeEvents } = await import('@spexcode/spec-core')
    const { anchorHitCommits, extractors } = await import('@spexcode/spec-core')
