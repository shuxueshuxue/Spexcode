...
const ICONS = {
  ...
  // The mirrored pair that toggles the LEFT and RIGHT docks. The owned pane is drawn SOLID, the way an
  // editor's sidebar toggle draws it: a 40%-tinted pane read as a faint smudge at 16px and the switch
  // disappeared into the corner. Two lanes once landed green separately —
  ...
  'panel-left': {
    vb: 18, sw: 1.4,
    node: <><path d="M6.4 2.5H3.1a1.6 1.6 0 0 0-1.6 1.6v9.8a1.6 1.6 0 0 0 1.6 1.6h3.3z" fill="currentColor" stroke="none" /><rect x="1.5" y="2.5" width="15" height="13" rx="1.6" /><path d="M6.4 2.5v13" /></>,
  },
  'panel-right': {
    vb: 18, sw: 1.4,
    node: <><path d="M11.6 2.5h3.3a1.6 1.6 0 0 1 1.6 1.6v9.8a1.6 1.6 0 0 1-1.6 1.6h-3.3z" fill="currentColor" stroke="none" /><rect x="1.5" y="2.5" width="15" height="13" rx="1.6" /><path d="M11.6 2.5v13" /></>,
  },
