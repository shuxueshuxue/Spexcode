export default {
  ...
  session: {
    ...
    harnessTargetPlugin: '插件目录',
    harnessTargetNativeSelect: '内置 harness',
    harnessTargetPluginFolder: '插件目录',
    harnessTargetPluginHelp: '插件目录是宿主智能体扫描插件的目录。SpexCode 会写入 <目录>/plugins/spexcode；只有使用插件宿主时才选择它，不要把它当作内置 harness。',
