...
scenarios:
  - name: clean-source-launcher-builds-runtime-closure
    tags: [cli]
    description: >
      Construct a source-shaped workspace with its CLI/core/eval/forge dist directories absent, then invoke
      the real CLI launcher.
    expected: >
      The launcher invokes the workspace build once, all four compiled entries exist, and the compiled CLI
