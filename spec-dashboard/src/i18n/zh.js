export default {
  ...
  session: {
    ...
    // 只读论坛信息页（[[forum-view]]）—— 新建会话旁的第二个顶部按钮。
    forumTitle: '论坛 —— 阅读 git 原生的提案与备注',
    forumOff: '论坛已关闭。',
    forumEmpty: '论坛为空。',
    forumLoading: '正在加载论坛……',
    forumFocusNode: '在看板上聚焦此节点',
    forumKind: { proposal: '提案', note: '备注' },
    forumSigned: ({ n }) => `+${n} 已签署`,
    forumReplies: ({ n }) => `${n} 条回复`,
    // 人工写入路径（[[forum-view]]）—— 回复输入框 + 新建提案/备注。
    forumNew: '新建',
    forumCancel: '取消',
    forumSend: '发送',
    forumPost: '发布',
    forumSending: '发送中……',
    forumMentionHint: '@会话 召唤 · [[节点]] 关联',
    forumReplyPlaceholder: '回复……',
    forumConcernPlaceholder: '关切 —— 一行概述',
    forumNodesPlaceholder: '节点 id，逗号分隔（可选）',
    forumBodyPlaceholder: '详情（可选）',
    ask: '你想做点什么？',
