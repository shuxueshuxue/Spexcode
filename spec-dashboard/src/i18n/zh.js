export default {
  ...
  session: {
    ...
    issuesActing: '处理中……',
    issuesSign: '签署',
    issuesSignTitle: '签署此 issue —— 为它 +1',
    issuesAccept: '接受',
    issuesAcceptTitle: '解决为 accepted —— 已认可、尚未落地（仍在列表中）',
    issuesReject: '拒绝',
    issuesRejectTitle: '解决为 rejected —— 已了结，收进归档',
    issuesPromote: '升级',
    issuesPromoteTitle: '升级到 forge —— 创建真实 forge issue，然后以 landed 收束本地线程并留下永久链接',
