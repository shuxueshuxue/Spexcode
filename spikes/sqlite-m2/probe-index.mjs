...
const HEAD = "SELECT * FROM protocol_messages WHERE target_session_id=? AND dequeued_at_ms IS NULL ORDER BY enqueue_seq LIMIT 1"
const HISTORY = "SELECT * FROM protocol_messages WHERE target_session_id=? AND enqueue_seq>? ORDER BY enqueue_seq"
