export default {
  ...
  projects: {
    ...
    adding: '注册中…',
    addFailed: '仓库注册失败',
    pathPlaceholder: '/仓库的/绝对路径',
    pathLabel: '仓库路径',
    harnessLabel: 'harness',
    harnessRequired: '至少选择一个 harness — init 只为你选中的 harness 物化。',
    open: '打开',
    start: '启动',
    starting: '启动中…',
    doctor: 'doctor',
    doctorRunning: 'doctor…',
    doctorEmpty: '（doctor 没有输出）',
    init: 'init',
    initConfirm: '运行 init',
    initRunning: 'init…',
    close: '收起',
  ...
  session: {
    ...
    modeInteractive: '有头',
    modeHeadless: '无头',
    headlessServerSide: '服务端执行，无独立指令',
    modeUnavailableTip: '该启动器没有无头指令——在 spexcode.json / spexcode.local.json 给它加 "headlessCmd"',
    modeFellBack: '{name} 当前不可用无头模式——已回落有头',
    tabTerminal: '终端',
    tabChat: '聊天',
    tabEval: '评测',
    typeBtn: '终端交互',
