...
import { useT } from './i18n/index.jsx'
  ...
  // The multi-select mode's top bar ([[session-multi-select]]): a live pick count + adjacent close action. It owns
  // one confirm + endpoint fan-out, but NOT the picking itself — which
