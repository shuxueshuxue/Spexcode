...
scenarios:
  ...
  - name: eval-tab-and-resource-picker-order
    ...
    expected: >-
      ...
      matching divider. Files and the Terminal/Conversation switch use the same icon gap as the command tools,
      with no wrapper-created group gutter. There is no flexible spacer or separate Eval control between the
      resource tabs, Eval, and picker.
