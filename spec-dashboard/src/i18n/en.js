export default {
  ...
  projects: {
    ...
    count: '{n} project(s)',
    current: 'current',
    empty: 'No projects yet — add a repository to govern it.',
    absent: 'This deployment serves a single project — the multi-project catalog is not available here.',
    add: 'add repository',
    addCancel: 'cancel',
    addConfirm: 'register',
    adding: 'registering…',
    addFailed: 'registering the repository failed',
    pathPlaceholder: '/absolute/path/to/repository',
    pathLabel: 'repository path',
    harnessLabel: 'harnesses',
    harnessRequired: 'pick at least one harness — the init materializes for exactly the harnesses you choose.',
    open: 'open',
    start: 'start',
    starting: 'starting…',
    doctor: 'doctor',
    doctorRunning: 'doctor…',
    doctorEmpty: '(doctor reported nothing)',
    init: 'init',
    initConfirm: 'run init',
    initRunning: 'init…',
    close: 'close',
  ...
  session: {
    ...
    headlessServerSide: 'runs server-side — no command of its own',
    modeUnavailableTip: 'no headless command — add "headlessCmd" to this launcher in spexcode.json / spexcode.local.json',
    modeFellBack: 'headless is unavailable for {name} — fell back to interactive',
