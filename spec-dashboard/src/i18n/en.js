export default {
  ...
  session: {
    ...
    addHarnessTargetDescription: 'Choose where this project should receive SpexCode delivery, then materialize the updated configuration. External adapters are managed outside the dashboard.',
    harnessTargetMode: 'target type',
    harnessTargetNative: 'built-in harness',
    harnessTargetPlugin: 'plugin host folder',
    harnessTargetNativeSelect: 'built-in harness',
    harnessTargetPluginFolder: 'plugin host folder',
    harnessTargetPluginHelp: 'This is not .spec/spexcode/.plugins: that is SpexCode\'s built-in plugin source. Enter the project folder scanned by the external agent, such as .claude or .adopter-a. The generated bundle will be at <folder>/plugins/spexcode.',
